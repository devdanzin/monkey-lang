...
const builtinNames = ['len', 'first', 'last', 'rest', 'push', 'puts', 'type', 'str', 'int', 'format', 'range', 'split', 'join', 'trim', 'upper', 'lower', 'contains', 'indexOf', 'replace', 'reverse', 'abs', 'min', 'max', 'startsWith', 'endsWith', 'char', 'ord', 'keys', 'values', 'sort'];
