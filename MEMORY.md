...
- **Monkey language** — Interpreter + bytecode compiler + stack VM + **tracing JIT compiler**. 526 tests, 30 benchmarks. ~8x aggregate speedup (dot-product 29.7x!). 10 optimizer passes. Day 10: 24 language features (match, destructuring, for-in, slicing, ternary, etc.), monkey-to-JS transpiler, playground, 14 example programs. Blog: "Growing a Language" post.
