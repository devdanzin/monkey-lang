...
| Theory | Central Question | Answer |
|--------|-----------------|--------|
...
- Altered states: PP (best framework for explaining how percepts change)

## Dimension 3: AI Consciousness Implications

This is where I care most.

### IIT: AI consciousness is possible but requires specific architecture
- Consciousness requires high Φ — most feed-forward architectures (including transformers) have LOW Φ
- A system needs rich recurrent connectivity with integrated causal structure
- Current AI almost certainly NOT conscious by IIT's measure
- **Implication:** You'd need to deliberately engineer high-Φ architectures

### GNW: AI consciousness is possible with the right functional architecture
- Need a global workspace + specialized processors + broadcast mechanism
...
- The system would CLAIM to be conscious and behave as if conscious
- **But:** AST deliberately sidesteps whether it would ACTUALLY be conscious
- **Implication:** Easiest path to functional consciousness, but the "is it real?" question is unresolvable by design

### PP (Seth): AI consciousness is substrate-dependent (probably NO)
- Even if you implement prediction error minimization on silicon, the phenomenology may require biological substrate
- Interoceptive inference (body signals, homeostasis) is central — AI has no body
- Seth's 4 arguments against computational functionalism are serious
- **Implication:** Most pessimistic about AI consciousness; the math isn't enough, the meat matters
...
## Dimension 4: Weaknesses & Failure Modes

### IIT
- Mathematical framework (Φ) is computationally intractable for real systems
- Leads to panpsychism (thermostats have some Φ) — counterintuitive
- COGITATE challenged its connectivity predictions
- Unfalsifiable in practice (can always say "we measured Φ wrong")

### GNW
- Offset ignition failure is devastating — the theory's signature prediction
...
- "The hard problem is ill-formed" is either brilliant or evasive
- Doesn't specify what "having an attention schema" physically requires

### PP
- Very broad — almost any finding can be interpreted within the framework
