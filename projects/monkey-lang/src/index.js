// Monkey Language — Main Entry Point
// Five execution backends: eval, VM, JIT, transpiler, WASM
...
export { disassemble as wasmDisassemble, WasmDisassembler, BinaryReader } from './wasm-dis.js';
