...
When you sense a session is getting long, or when the pre-compaction flush fires:
1. Write key facts, decisions, and context to today's daily log
2. If anything is truly durable, promote it to MEMORY.md
3. Update entity pages if you learned about people/systems
4. Then reply NO_REPLY so the user doesn't see the flush

### End-of-Day Summary
A cron job runs at 11 PM MDT daily to:
- Summarize daily logs if they're too long
- Promote durable facts to MEMORY.md
- Update reflections, opinions, and entity pages
